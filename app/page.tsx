...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-3 mb-4">
      ...
      <h3 className="text-xl font-bold text-foreground font-handwritten tracking-wide">{children}</h3>
    </div>
  );
}
...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center py-12 px-4 sm:px-6">
      <main id="main-content" role="main" className="w-full max-w-4xl space-y-12">
        {/* Hero */}
        <header className="relative">
          ...
          <Card className="w-full max-w-2xl mx-auto p-8 relative overflow-hidden">
            ...
            <div className="mt-8 mb-6">
              <svg className="hand-accent-svg text-primary" viewBox="0 0 280 24" aria-hidden>
                <path className="path" d="M4 12 C44 2 84 22 140 10 C196 -2 236 16 276 10" stroke="currentColor" strokeWidth="3" fill="none" />
              </svg>
            </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <Card className="h-full flex flex-col">
              <article role="article" aria-labelledby="proj-a">
                ...
                <h4 id="proj-a" className="text-xl font-bold mb-2 font-handwritten">示例项目 A</h4>
            ...
            <Card className="h-full flex flex-col">
              <article role="article" aria-labelledby="proj-b">
                ...
                <h4 id="proj-b" className="text-xl font-bold mb-2 font-handwritten">示例项目 B</h4>
                <p className="text-sm text-foreground/80">
        ...
        <section>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <Card className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-muted uppercase tracking-wider font-bold">邮箱</p>
                <p className="text-foreground font-medium">example@example.com</p>
              </div>
            </Card>
            <Card className="flex items-center gap-4">
              <div className="text-2xl">🌏</div>
              <div>
                <p className="text-xs text-muted uppercase tracking-wider font-bold">社交</p>
                <p className="text-foreground font-medium">GitHub / Twitter / 微信</p>
              </div>
            </Card>
          </div>
        </section>
